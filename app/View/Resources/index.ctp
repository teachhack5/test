<div class="resources index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('dateexpires');?></th>
	...
	<tr>
		...
		<td><?php echo h($resource['Resource']['active']); ?>&nbsp;</td>
		<td><?php echo h($resource['Resource']['dateexpires']); ?>&nbsp;</td>
		<td><?php echo h($resource['Resource']['datecreated']); ?>&nbsp;</td>
		<td><?php echo h($resource['Resource']['datemodified']); ?>&nbsp;</td>
		<td class="actions">
